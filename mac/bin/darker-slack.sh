#! /bin/bash
# ref: https://github.com/widget-/slack-black-them://github.com/widget-/slack-black-theme
# ref: https://cdn.rawgit.com/laCour/slack-night-mode/master/css/raw/black.css
